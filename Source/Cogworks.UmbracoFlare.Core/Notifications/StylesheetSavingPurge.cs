...
{
    public class StylesheetSavingPurge : INotificationHandler<StylesheetSavingNotification>
    {
        private readonly IConfigurationService configurationService;
        private readonly ICloudflareService cloudflareService;
        private readonly IUmbracoFlareUrlService urlService;

        public StylesheetSavingPurge(IConfigurationService configurationService, ICloudflareService cloudflareService, IUmbracoFlareUrlService urlService)
        {
        ...
        public void Handle(StylesheetSavingNotification notification)
        {
